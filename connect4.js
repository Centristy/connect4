...
class Game {
  ...
  constructor(p1, p2, WIDTH = 7, HEIGHT = 6){
    ...
    this.makeBoard();
    this.makeHtmlBoard();
    this.gameOver = false; // this will stop the game once someone has won
...
/** makeHtmlBoard: make HTML table and row of column tops. */
  ...
  board.innerHTML = ''; // this will reset the board
...
document.getElementById('start').addEventListener('click', () => {
  let p1 = new Player(document.getElementById('color').value);
